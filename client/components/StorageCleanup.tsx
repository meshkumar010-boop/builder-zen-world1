...
export default function StorageCleanup() {
  ...
  const base64Count = productsWithSize.reduce(
    (count, product) =>
      count + product.images.filter((img) => img.startsWith("data:")).length,
    0,
  );
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-sm font-medium ${getStorageColor(storageInfo.percentUsed)}`}
            >
          ...
          <div className="relative">
            <Progress value={storageInfo.percentUsed} className="h-3" />
            <div
          ...
          {storageInfo.percentUsed >= 90 && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Storage is {storageInfo.percentUsed.toFixed(1)}% full. Consider
                cleaning up to avoid errors.
              </AlertDescription>
            </Alert>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid gap-3">
            ...
            <Button
              onClick={() =>
                handleCleanup(removeBase64Images, "Remove base64 images")
              }
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p>
            <strong>Auto Cleanup:</strong> Removes base64 images first, then
            oldest products if needed
          </p>
          <p>
            <strong>Base64 Images:</strong> Large embedded images stored locally
            (fallback when cloud upload fails)
          </p>
          <p>
            <strong>URL Images:</strong> Cloud-hosted images (Firebase,
            Cloudinary, etc.) - these are preserved
          </p>
        </div>
      </CardContent>
    </Card>
